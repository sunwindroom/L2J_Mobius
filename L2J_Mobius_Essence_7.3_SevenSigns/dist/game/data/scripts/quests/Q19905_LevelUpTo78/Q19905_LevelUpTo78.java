 ...
 */
package quests.Q19905_LevelUpTo78;
 ...
 * @author Magik
 */
public class Q19905_LevelUpTo78 extends Quest
{
	private static final int QUEST_ID = 19905;
	
	public Q19905_LevelUpTo78()
	{
		super(QUEST_ID);
	}
	...
	public void onPlayerLevelChange(OnPlayerLevelChanged event)
	{
		...
		else if ((questState != null) && questState.isStarted() && !questState.isCompleted() && (player.getLevel() == 78))
		{
			questState.setCount(getQuestData().getGoal().getCount());
			questState.setCond(QuestCondType.DONE);
			player.sendPacket(new ExQuestNotification(questState));
