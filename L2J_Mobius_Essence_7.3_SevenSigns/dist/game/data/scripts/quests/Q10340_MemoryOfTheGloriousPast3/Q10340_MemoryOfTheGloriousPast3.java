 ...
 */
package quests.Q10340_MemoryOfTheGloriousPast3;
...
import quests.Q19902_LevelUpTo64.Q19902_LevelUpTo64;

/**
 * @author Magik
 */
public class Q10340_MemoryOfTheGloriousPast3 extends Quest
{
	private static final int QUEST_ID = 10340;
	private static final int[] MONSTERS =
	{
		20681, // VANOR_SILENOS
		20682, // VANOR_SILENOS_SOLDIER
		20683, // VANOR_SILENOS_SCOUT
		20684, // VANOR_SILENOS_WARRIOR
		20685, // VANOR_SILENOS_SHAMAN
		20686, // VANOR_SILENOS_CHIEFTAIN
		24014, // VANOR_MERCENARY_OF_GLORY
		22102, // GUARD_OF_HONOR
	};
	
	public Q10340_MemoryOfTheGloriousPast3()
	{
		super(QUEST_ID);
		addKillId(MONSTERS);
	}
	...
	public String onEvent(String event, Npc npc, Player player)
	{
		switch (event)
		{
			...
			case "COMPLETE":
			{
				...
				final QuestState nextQuestState = player.getQuestState(Q19902_LevelUpTo64.class.getSimpleName());
				if ((nextQuestState == null) || nextQuestState.getQuest().canStartQuest(player))
				{
					player.sendPacket(new ExQuestDialog(19902, QuestDialogType.ACCEPT));
				}
				break;
			}
		}
