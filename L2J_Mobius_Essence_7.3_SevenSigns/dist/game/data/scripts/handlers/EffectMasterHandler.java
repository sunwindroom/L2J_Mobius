...
public class EffectMasterHandler
{
	...
	public static void main(String[] args)
	{
		...
		EffectHandler.getInstance().registerHandler("AdditionalPhysicalDamage", AdditionalPhysicalDamage::new);
		...
		EffectHandler.getInstance().registerHandler("CallSkillByEnemyRace", CallSkillByEnemyRace::new);
		EffectHandler.getInstance().registerHandler("CallSkillByKill", CallSkillByKill::new);
		...
		EffectHandler.getInstance().registerHandler("CallSkillOnEnemyDeath", CallSkillOnEnemyDeath::new);
		...
		EffectHandler.getInstance().registerHandler("FeedModify", FeedModify::new);
		...
		EffectHandler.getInstance().registerHandler("MagicalAttackByPhysicalAttack", MagicalAttackByPhysicalAttack::new);
		...
		EffectHandler.getInstance().registerHandler("PhysicalDamageByTargets", PhysicalDamageByTargets::new);
		...
		EffectHandler.getInstance().registerHandler("ShadowBlast", ShadowBlast::new);
		...
		EffectHandler.getInstance().registerHandler("SummonShadow", SummonShadow::new);
		...
		EffectHandler.getInstance().registerHandler("UnsummonCubic", UnsummonCubic::new);
