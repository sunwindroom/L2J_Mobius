...
public enum ServerPackets
{
	...
	EX_NET_LATENCY(0xFE, 0x266),
	EX_MABLE_GAME_SHOW_PLAYER_STATE(0xFE, 0x267),
	EX_MABLE_GAME_DICE_RESULT(0xFE, 0x268),
	EX_MABLE_GAME_MOVE(0xFE, 0x269),
	EX_MABLE_GAME_PRISON(0xFE, 0x26A),
	EX_MABLE_GAME_REWARD_ITEM(0xFE, 0x26B),
	EX_MABLE_GAME_SKILL_INFO(0xFE, 0x26C),
	EX_MABLE_GAME_MINIGAME(0xFE, 0x26D),
	EX_MABLE_GAME_PLAY_UNABLE(0xFE, 0x26E),
	EX_MABLE_GAME_UI_LAUNCHER(0xFE, 0x26F),
	EX_MABLE_GAME_ROLL_COUNT_RESET(0xFE, 0x270),
	EX_PET_SKILL_LIST(0xFE, 0x271),
	EX_OPEN_BLESS_OPTION_SCROLL(0xFE, 0x272),
	EX_BLESS_OPTION_PUT_ITEM(0xFE, 0x273),
	EX_BLESS_OPTION_ENCHANT(0xFE, 0x274),
	EX_BLESS_OPTION_CANCEL(0xFE, 0x275),
	EX_PVP_RANKING_MY_INFO(0xFE, 0x276),
	EX_PVP_RANKING_LIST(0xFE, 0x277),
	EX_PLEDGE_V3_INFO(0xFE, 0x278),
	EX_PLEDGE_ENEMY_INFO_LIST(0xFE, 0x279),
	EX_ITEM_DELETION_INFO(0xFE, 0x27A),
	// 272
	EX_PK_PENALTY_LIST(0xFE, 0x27B),
	EX_PK_PENALTY_LIST_ONLY_LOC(0xFE, 0x27C),
	EX_SHOW_PET_EXTRACT_SYSTEM(0xFE, 0x27D),
	EX_RESULT_PET_EXTRACT_SYSTEM(0xFE, 0x27E),
	EX_HIDE_PET_EXTRACT_SYSTEM(0xFE, 0x27F),
	// 306
	EX_RANKING_FESTIVAL_SIDEBAR_INFO(0xFE, 0x280),
	EX_RANKING_FESTIVAL_BUY(0xFE, 0x281),
	EX_RANKING_FESTIVAL_BONUS(0xFE, 0x282),
	EX_RANKING_FESTIVAL_RANKING(0xFE, 0x283),
	EX_RANKING_FESTIVAL_MYINFO(0xFE, 0x284),
	EX_RANKING_FESTIVAL_MY_RECEIVED_BONUS(0xFE, 0x285),
	EX_RANKING_FESTIVAL_REWARD(0xFE, 0x286),
	EX_TIMER_CHECK(0xFE, 0x287),
	EX_STEADY_BOX_UI_INIT(0xFE, 0x288),
	EX_STEADY_ALL_BOX_UPDATE(0xFE, 0x289),
	EX_STEADY_ONE_BOX_UPDATE(0xFE, 0x28A),
	EX_STEADY_BOX_REWARD(0xFE, 0x28B),
	EX_PET_RANKING_MY_INFO(0xFE, 0x28C),
	EX_PET_RANKING_LIST(0xFE, 0x28D),
	EX_COLLECTION_INFO(0xFE, 0x28E),
	EX_COLLECTION_OPEN_UI(0xFE, 0x28F),
	EX_COLLECTION_CLOSE_UI(0xFE, 0x290),
	EX_COLLECTION_LIST(0xFE, 0x291),
	EX_COLLECTION_UPDATE_FAVORITE(0xFE, 0x292),
	EX_COLLECTION_FAVORITE_LIST(0xFE, 0x293),
	EX_COLLECTION_SUMMARY(0xFE, 0x294),
	EX_COLLECTION_REGISTER(0xFE, 0x295),
	EX_COLLECTION_COMPLETE(0xFE, 0x296),
	EX_COLLECTION_RECEIVE_REWARD(0xFE, 0x297),
	EX_COLLECTION_RESET(0xFE, 0x298),
	EX_COLLECTION_ACTIVE_EVENT(0xFE, 0x299),
	EX_COLLECTION_RESET_REWARD(0xFE, 0x29A),
	EX_PVPBOOK_SHARE_REVENGE_LIST(0xFE, 0x29B),
	EX_PVPBOOK_SHARE_REVENGE_KILLER_LOCATION(0xFE, 0x29C),
	EX_PVPBOOK_SHARE_REVENGE_NEW_REVENGEINFO(0xFE, 0x29D),
	EX_PENALTY_ITEM_DROP(0xFE, 0x29E),
	EX_PENALTY_ITEM_LIST(0xFE, 0x29F),
	EX_PENALTY_ITEM_RESTORE(0xFE, 0x2a0),
	EX_USER_WATCHER_TARGET_LIST(0xFE, 0x2a1),
	EX_USER_WATCHER_TARGET_STATUS(0xFE, 0x2a2),
	EX_HOMUNCULUS_ACTIVATE_SLOT_RESULT(0xFE, 0x2a3),
	EX_SHOW_HOMUNCULUS_COUPON_UI(0xFE, 0x2a4),
	EX_SUMMON_HOMUNCULUS_COUPON_RESULT(0xFE, 0x2a5),
	EX_PENALTY_ITEM_INFO(0xFE, 0x2a6),
	EX_MAGIC_SKILL_USE_GROUND(0xFE, 0x2a7),
	EX_SUBJUGATION_SIDEBAR(0xFE, 0x2a8),
	EX_SUBJUGATION_LIST(0xFE, 0x2a9),
	EX_SUBJUGATION_RANKING(0xFE, 0x2aA),
	EX_SUBJUGATION_GACHA_UI(0xFE, 0x2aB),
	EX_SUBJUGATION_GACHA(0xFE, 0x2aC),
	EX_USER_VIEW_INFO_PARAMETER(0xFE, 0x2aD),
	EX_PLEDGE_DONATION_INFO(0xFE, 0x2aE),
	EX_PLEDGE_DONATION_REQUEST(0xFE, 0x2aF),
	EX_PLEDGE_CONTRIBUTION_LIST(0xFE, 0x2b0),
	EX_PLEDGE_RANKING_MY_INFO(0xFE, 0x2b1),
	EX_PLEDGE_RANKING_LIST(0xFE, 0x2b2),
	EX_ITEM_RESTORE_LIST(0xFE, 0x2b3),
	EX_ITEM_RESTORE(0xFE, 0x2b4),
	EX_PLEDGE_COIN_INFO(0xFE, 0x2b5),
	// 338
	EX_DETHRONE_INFO(0xFE, 0x2b6),
	EX_DETHRONE_RANKING_INFO(0xFE, 0x2b7),
	EX_DETHRONE_SERVER_INFO(0xFE, 0x2b8),
	EX_DETHRONE_DISTRICT_OCCUPATION_INFO(0xFE, 0x2b9),
	EX_DETHRONE_DAILY_MISSION_INFO(0xFE, 0x2bA),
	EX_DETHRONE_DAILY_MISSION_GET_REWARD(0xFE, 0x2bB),
	EX_DETHRONE_DAILY_MISSION_COMPLETE(0xFE, 0x2bC),
	EX_DETHRONE_PREV_SEASON_INFO(0xFE, 0x2bD),
	EX_DETHRONE_GET_REWARD(0xFE, 0x2bE),
	EX_DETHRONE_CHECK_NAME(0xFE, 0x2bF),
	EX_DETHRONE_CHANGE_NAME(0xFE, 0x2c0),
	EX_DETHRONE_CONNECT_CASTLE(0xFE, 0x2c1),
	EX_DETHRONE_DISCONNECT_CASTLE(0xFE, 0x2c2),
	EX_DETHRONE_SEASON_INFO(0xFE, 0x2c3),
	EX_SERVERLIMIT_ITEM_ANNOUNCE(0xFE, 0x2c4),
	EX_CHANGE_NICKNAME_COLOR_ICON(0xFE, 0x2c5),
	EX_WORLDCASTLEWAR_HOST_CASTLE_SIEGE_HUD_INFO(0xFE, 0x2c6),
	EX_WORLDCASTLEWAR_CASTLE_INFO(0xFE, 0x2c7),
	EX_WORLDCASTLEWAR_CASTLE_SIEGE_INFO(0xFE, 0x2c8),
	EX_WORLDCASTLEWAR_CASTLE_SIEGE_HUD_INFO(0xFE, 0x2c9),
	EX_WORLDCASTLEWAR_CASTLE_SIEGE_ATTACKER_LIST(0xFE, 0x2cA),
	EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_LIST(0xFE, 0x2cB),
	EX_WORLDCASTLEWAR_PLEDGE_MERCENARY_MEMBER_JOIN(0xFE, 0x2cC),
	EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_OCCUPY_INFO(0xFE, 0x2cD),
	EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_INFO(0xFE, 0x2cE),
	EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HERO_WEAPON_USER(0xFE, 0x2cF),
	EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_SIEGE_GOLEM_INFO(0xFE, 0x2d0),
	EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_DOOR_INFO(0xFE, 0x2d1),
	EX_WORLDCASTLEWAR_SIEGE_MAINBATTLE_HUD_INFO(0xFE, 0x2d2),
	EX_PRIVATE_STORE_SEARCH_ITEM(0xFE, 0x2d3),
	EX_PRIVATE_STORE_SEARCH_HISTORY(0xFE, 0x2d4),
	EX_PRIVATE_STORE_SEARCH_STATISTICS(0xFE, 0x2d5),
	EX_NEW_HENNA_LIST(0xFE, 0x2d6),
	EX_NEW_HENNA_EQUIP(0xFE, 0x2d7),
	EX_NEW_HENNA_UNEQUIP(0xFE, 0x2d8),
	EX_NEW_HENNA_POTEN_SELECT(0xFE, 0x2d9),
	EX_NEW_HENNA_POTEN_ENCHANT(0xFE, 0x2dA),
	EX_NEW_HENNA_COMPOSE(0xFE, 0x2dB),
	EX_REQUEST_INVITE_PARTY(0xFE, 0x2dC),
	EX_INIT_GLOBAL_EVENT_UI(0xFE, 0x2dD),
	EX_SHOW_GLOBAL_EVENT_UI(0xFE, 0x2dE),
	EX_L2PASS_SIMPLE_INFO(0xFE, 0x2dF),
	EX_L2PASS_INFO(0xFE, 0x2e0),
	EX_SAYHAS_SUPPORT_INFO(0xFE, 0x2e1),
	// 362
	EX_RES_ENCHANT_ITEM_FAIL_REWARD_INFO(0xFE, 0x2e2),
	EX_CHANGED_ENCHANT_TARGET_ITEM_PROB_LIST(0xFE, 0x2e3),
	EX_ENCHANT_CHALLENGE_POINT_INFO(0xFE, 0x2e4),
	EX_SET_ENCHANT_CHALLENGE_POINT(0xFE, 0x2e5),
	EX_RESET_ENCHANT_CHALLENGE_POINT(0xFE, 0x2e6),
	EX_RES_SELECT_MULTI_ENCHANT_SCROLL(0xFE, 0x2e7),
	EX_RES_SET_MULTI_ENCHANT_ITEM_LIST(0xFE, 0x2e8),
	EX_RES_MULTI_ENCHANT_ITEM_LIST(0xFE, 0x2e9),
	EX_WORLDCASTLEWAR_HOST_SUPPORT_PLEDGE_RANKING_INFO(0xFE, 0x2eA),
	EX_WORLDCASTLEWAR_HOST_PLEDGE_RANKING_INFO(0xFE, 0x2eB),
	EX_WORLDCASTLEWAR_HOST_PERSONAL_RANKING_INFO(0xFE, 0x2eC),
	EX_WORLDCASTLEWAR_SUPPORT_PLEDGE_RANKING_INFO(0xFE, 0x2eD),
	EX_WORLDCASTLEWAR_PLEDGE_RANKING_INFO(0xFE, 0x2eE),
	EX_WORLDCASTLEWAR_PERSONAL_RANKING_INFO(0xFE, 0x2eF),
	EX_HOMUNCULUS_CREATE_PROB_LIST(0xFE, 0x2f0),
	EX_HOMUNCULUS_COUPON_PROB_LIST(0xFE, 0x2f1),
	EX_WORLDCASTLEWAR_HOST_CASTLE_SIEGE_RANKING_INFO(0xFE, 0x2f2),
	EX_WORLDCASTLEWAR_CASTLE_SIEGE_RANKING_INFO(0xFE, 0x2f3),
	EX_MISSION_LEVEL_REWARD_LIST(0xFE, 0x2f4),
	EX_BALROGWAR_SHOW_UI(0xFE, 0x2f5),
	EX_BALROGWAR_SHOW_RANKING(0xFE, 0x2f6),
	EX_BALROGWAR_GET_REWARD(0xFE, 0x2f7),
	EX_BALROGWAR_HUD(0xFE, 0x2f8),
	EX_BALROGWAR_BOSSINFO(0xFE, 0x2f9),
	EX_USER_RESTART_LOCKER_LIST(0xFE, 0x2fA),
	EX_USER_RESTART_LOCKER_UPDATE(0xFE, 0x2fB),
	EX_WORLD_EXCHANGE_ITEM_LIST(0xFE, 0x2fC),
	EX_WORLD_EXCHANGE_REGI_ITEM(0xFE, 0x2fD),
	EX_WORLD_EXCHANGE_BUY_ITEM(0xFE, 0x2fE),
	EX_WORLD_EXCHANGE_SETTLE_LIST(0xFE, 0x2fF),
	EX_WORLD_EXCHANGE_SETTLE_RECV_RESULT(0xFE, 0x300),
	EX_WORLD_EXCHANGE_SELL_COMPLETE_ALARM(0xFE, 0x301),
	EX_READY_ITEM_AUTO_PEEL(0xFE, 0x302),
	EX_RESULT_ITEM_AUTO_PEEL(0xFE, 0x303),
	EX_STOP_ITEM_AUTO_PEEL(0xFE, 0x304),
	EX_TIME_RESTRICT_FIELD_DIE_LIMT_TIME(0xFE, 0x305),
	EX_APPLY_VARIATION_OPTION(0xFE, 0x306),
	EX_REQUEST_AUDIO_LOG_SAVE(0xFE, 0x307),
	...
	EX_WRANKING_FESTIVAL_BU(0xFE, 0x30C),
	...
	EX_RECEIVED_POST_LIST(0xFE, 0x313),
	EX_TIME_RESTRICT_FIELD_SERVER_GROUP(0xFE, 0x314),
	EX_TIME_RESTRICT_FIELD_ENTER_INFO(0xFE, 0x315),
	EX_WORLD_EXCHANGE_SETTLE_ALARM(0xFE, 0x316),
	EX_HERO_BOOK_INFO(0xFE, 0x317),
