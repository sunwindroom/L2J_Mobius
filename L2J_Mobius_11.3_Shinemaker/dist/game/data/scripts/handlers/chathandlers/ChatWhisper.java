...
public class ChatWhisper implements IChatHandler
{
	...
	public void handleChat(ChatType type, Player activeChar, String target, String text)
	{
		...
		if ((receiver != null) && !receiver.isSilenceMode(activeChar.getObjectId()))
		{
			...
			{
				activeChar.sendPacket(new SystemMessage(SystemMessageId.PRIVATE_MESSAGES_CANNOT_BE_SENT_BY_CHARACTERS_OF_LV_S1_OR_LOWER_YOU_CAN_ONLY_ANSWER_THOSE_YOU_RECEIVE).addInt(Config.MINIMUM_CHAT_LEVEL));
				return;
			}
